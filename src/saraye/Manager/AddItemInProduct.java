 ...
 * @author Haseeb
 */
public class AddItemInProduct extends javax.swing.JFrame {
    ...
    String n = "";
    String[] item_product;
    int[] item_product_quantity;
    public AddItemInProduct(M_Manager man,String name,String[] items_in_product,int[] items_in_product_quantity) {
        initComponents();
        n=name;
        m=man;
        item_product=items_in_product;
        item_product_quantity = items_in_product_quantity;
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Add Item in Product");
    ...
    public static void main(String args[],M_Manager man,String name,String[] items_in_product,int[] items_in_product_quantity) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddItemInProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddItemInProduct(man,name,items_in_product,items_in_product_quantity).setVisible(true);
            }
        });
    }
